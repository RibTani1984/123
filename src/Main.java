public class Main {
    public static void main(String[] args) {
        ...
        SalesManager Manager1 = new SalesManager(new long[]{150, 200, 30, 50, 450});
        SalesManager Manager2 = new SalesManager(new long[]{50, 500, 20, 100, 380});
        SalesManager Manager3 = new SalesManager(new long[]{250, 20, 150, 300, 15});
